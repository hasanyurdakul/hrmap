...
function DropdownNotifications({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-white py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
      ...
      >
        ...
        >
          ...
          <ul>
            <li className="border-b border-gray-200 dark:border-white last:border-0">
              <Link
